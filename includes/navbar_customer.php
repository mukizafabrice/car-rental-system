    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="customerNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link text-dark" href="view_cars.php"><i class="bi bi-car-front"></i> View Cars</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href="change_password.php"><i class="bi bi-key"></i> Change Password</a>
                </li>
                <li class="nav-item">
